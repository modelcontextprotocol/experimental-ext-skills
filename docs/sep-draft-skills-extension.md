...
>
> This file is the v1 baseline: a verbatim copy of the canonical SEP at commit [`4ef73ea`](https://github.com/modelcontextprotocol/modelcontextprotocol/blob/4ef73eaf91b8b0ae0dbff9a4dddff44fc095d7fd/seps/2640-skills-extension.md) (2026-08-20) on the [`sep/skills-extension`](https://github.com/modelcontextprotocol/modelcontextprotocol/blob/sep/skills-extension/seps/2640-skills-extension.md) branch, kept here so Working Group discussion and decision records can quote and link stable text. It is only as current as that pinned commit. For what v1 comprises and why, see the 2026-07-16 v1 scope entry in the [decision log](decisions.md).
>
