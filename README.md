...
| [SEP-2640: Skills Extension](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/2640) | Proposal to serve skills over MCP via the Resources primitive. A synced snapshot of the canonical text is kept at [`docs/sep-draft-skills-extension.md`](docs/sep-draft-skills-extension.md) for reference and linking. Comments and review happen on the PR; proposals beyond v1 are raised as PRs in this repository. |
